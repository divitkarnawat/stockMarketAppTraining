...
export default class ShowCompaniesInStockExchange extends React.Component{
    constructor(props)
    {
        super(props);
        this.data = [];
    ...
    componentDidMount()
    {
        axios.get(`https://stock-market-app-java-divitk.herokuapp.com/stock_exchanges/` + this.props.id + `/companies`)
        .then(response => {
    ...
    render()
    {
        return(
            <div className = "container">
              <h1> List of Companies in Stock Exchange</h1>
