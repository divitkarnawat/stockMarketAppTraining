...
const textFieldLabels = ["Email","Mobile Number"];
const textFieldNames = ["email","mobileNumber"];
...
export default class SignUpPage extends React.Component{
    ...
    render()
    {
        ...
        return(
           ...
           {
               this.state.globalError == "" ? `User Updated Successfully`  : this.state.globalError
           }
        </MuiAlert>
      </Snackbar>
            </div>
