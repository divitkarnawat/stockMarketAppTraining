...
const tableHeadings = ["Username","Email","Role","Mobile Number"];
const dataCells = ["username","email","role", "mobileNumber"];
...
export default class ShowAppUserList extends React.Component{
    constructor(props)
    {
        super(props);
        this.data = [];
