...
export default class ShowListedInStockExchange extends React.Component{
    constructor(props)
    {
        super(props);
        this.data = [];
    ...
    componentDidMount()
    {
        axios.get(`https://stock-market-app-java-divitk.herokuapp.com/companies/` + this.props.id + `/stock_exchanges`)
        .then(response => {
    ...
    render()
    {
        return(
            <div className = "container">
              <h1>Company listed in Stock Exchanges: </h1> 
