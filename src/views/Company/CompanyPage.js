...
import ShowListedInStockExchange from '../../components/Company/ShowListedInStockExchanges.js';
import AddCompany from '../../components/Company/AddCompany.js';
import UpdateCompany from '../../components/Company/UpdateCompany.js';
import ShowResourceById from '../../components/ResourceById/ShowResourceById.js';
import MaptoStockExchange from '../../components/Company/MaptoStockExchange.js';
import IPODetails from '../../components/Company/IPODetails.js';
...
const useStyles = makeStyles((theme) => ({
  ...
  export default function CompanyPage() {
    ...
    const renderComponent = (compId) =>
    {
        switch(compId)
        {
            case 0: return <ShowCompanyList openCompany = {openCompany}/>
            break;
            case 1: return <AddCompany />
            break;
            case 2: return <ShowResourceById res_name = "companies" id={id}/>
            break;
            case 3: return <UpdateCompany id={id} />
            break;
            case 4: return <ShowListedInStockExchange id = {id}/>
            break;
            case 5: return <MaptoStockExchange id = {id}/>
            break;
            case 6: return <IPODetails id = {id}/>
            break;
        }
    }
      ...
      <div className={classes.root}>
        ...
        >
          ...
          <List>
                ...
                <ListItemText primary="IPO Details" />
                </ListItem>
          </List>
        </Drawer>
