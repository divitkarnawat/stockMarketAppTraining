...
public class JwtUserDetailsService implements UserDetailsService {
	...
	public Collection<? extends GrantedAuthority> getAuthorities() {
		...
		com.divit.nonJWT.jwtClasses.User1 user = new com.divit.nonJWT.jwtClasses.User1() ;
   ...
   return authorities;
	...
	public UserDetails1 loadUserByUsername(String username) throws UsernameNotFoundException {
		com.divit.nonJWT.jwtClasses.User1 user = appUserRepository.findByName(username);
...
//implement without dto	public com.stockexchange.phase3.User1 save(UserDto user) {
	public com.divit.nonJWT.jwtClasses.User1 save(User1 user) {
		com.divit.nonJWT.jwtClasses.User1 newUser = new com.divit.nonJWT.jwtClasses.User1();
		...
		com.divit.nonJWT.jwtClasses.User1 userSaved = appUserRepository.save(newUser);
